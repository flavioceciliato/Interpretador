...
public partial class LangBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ILangVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>termMulti</c>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitTermMulti([NotNull] LangParser.TermMultiContext context) { return VisitChildren(context); }
	/// <summary>
