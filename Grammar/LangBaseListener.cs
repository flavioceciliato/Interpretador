...
public partial class LangBaseListener : ILangListener {
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>termMulti</c>
	/// labeled alternative in <see cref="LangParser.term"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterTermMulti([NotNull] LangParser.TermMultiContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>termMulti</c>
	/// labeled alternative in <see cref="LangParser.term"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitTermMulti([NotNull] LangParser.TermMultiContext context) { }
	/// <summary>
